        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex flex-col gap-1 flex-1">
              ...
              <input
                ...
                className="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-uw-purple"
              />
            </div>
            <div className="flex flex-col gap-1 flex-1">
              <label className="text-xs text-gray-500 uppercase tracking-wide">
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea
              ...
              rows={2}
              className="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-uw-purple resize-none"
            />
          </div>
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className="bg-uw-purple text-white rounded px-5 py-2 text-sm font-medium hover:bg-uw-purple-dark disabled:opacity-50 transition-colors"
            >
